...
void hash(std::string input, word* H) {
	//preprocessing
	pad(input);
	...
	for(int i = 0; i < blockCount; i++) {
		...
		for(int t = 0; t < 64; t++) {
			...
			std::cout << "\n[t" << t << "]\n";
			word debug[8] = {a, b, c, d, e, f, g, h};
			mem.compareArray((word*)debug, (word*)abc_working_variables[t], 8, true, true);
		}
